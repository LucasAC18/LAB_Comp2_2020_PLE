...
public class AlbumTest {
    ...
    public void testarRecebimentoPacotinhoQualquer() {
        ...
        for (int i = 0; i < QUANT_FIGURINHAS_POR_PACOTE; i++) {             //estava for (int i = 1; i <= QUANT_FIGURINHAS_POR_PACOTE; i++)
...
//        assertFalse(album.possuiFigurinhaRepetida(1));        teste contraditório com assert anterior(linha 52)
